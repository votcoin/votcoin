...
unlocked to sign the Votcoin-Qt.app bundle.
...
allowing somebody to distribute a Votcoin-Qt.app or votcoin-qt-setup.exe with a valid
...
that the votcoin-qt.exe file inside the installer had not been tampered with.
