...
#ifndef VOTCOIN_QT_VOTCOINUNITS_H
#define VOTCOIN_QT_VOTCOINUNITS_H
...
/** Votcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class VotcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit VotcoinUnits(QObject *parent);

    /** Votcoin units.
      @note Source: https://en.votcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        VCN,
...
typedef VotcoinUnits::Unit VotcoinUnit;

#endif // VOTCOIN_QT_VOTCOINUNITS_H
