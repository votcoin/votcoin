...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/votcoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Votcoin Core"),
     ...
     * override -datadir in the votcoin.conf file in the default data directory
     * (to be consistent with votcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
