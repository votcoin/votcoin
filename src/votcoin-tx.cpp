...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Votcoin Core votcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  votcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded votcoin transaction") + "\n" +
              "  votcoin-tx [options] -create [commands]   " + _("Create hex-encoded votcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded votcoin transaction
