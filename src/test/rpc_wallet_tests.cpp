...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CVotcoinAddress demoAddress = CVotcoinAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CVotcoinAddress setaccountDemoAddress = CVotcoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CVotcoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CVotcoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
