The following is a list of assets used in the votcoin source and their proper attribution.
...
* License: MIT
* Site: [https://votcointalk.org/index.php?topic=15276.0](https://votcointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original votcoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/votcoin.icns, src/qt/res/src/votcoin.svg,
	src/qt/res/src/votcoin.ico, src/qt/res/src/votcoin.png,
	src/qt/res/src/votcoin_testnet.png, docs/votcoin_logo_doxygen.png,
