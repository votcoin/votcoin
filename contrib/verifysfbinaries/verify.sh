...
###   This script attempts to download the signature file SHA256SUMS.asc from votcoin.org
...
WORKINGDIR="/tmp/votcoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://votcoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://votcoin.org/bin/"
VERSIONPREFIX="votcoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'votcoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[votcoin-]<version>-[rc[0-9]] (example: votcoin-0.9.2-rc1)"
   echo "wget output:"
